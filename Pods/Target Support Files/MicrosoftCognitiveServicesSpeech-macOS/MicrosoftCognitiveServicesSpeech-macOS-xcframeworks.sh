...
install_xcframework "${PODS_ROOT}/MicrosoftCognitiveServicesSpeech-macOS/MicrosoftCognitiveServicesSpeech.xcframework" "MicrosoftCognitiveServicesSpeech-macOS" "framework" "macos-arm64_x86_64"
